...
module.exports = {
    ...
    themeConfig: { // 主题配置
        ...
        repo: 'liujiawei-pro/myJavaDoc', // 导航栏右侧生成Github链接
        ...
        author: { // 文章默认的作者信息，可在md文件中单独配置此信息 String | {name: String, link: String}
            name: 'Liu Jiawei', // 必需
            link: 'https://github.com/liujiawei-pro' // 可选的
        },
            ...
            icons: [
                {
                    ...
                    title: '发邮件',
                    link: 'mailto:13580110589@163.com'
                },
                {
                    iconClass: 'icon-github',
                    title: 'GitHub',
                    link: 'https://github.com/liujiawei-pro'
                },
                {
                    iconClass: 'icon-erji',
                    title: '听音乐',
                    link: 'https://music.163.com/#/playlist?id=624876414'
                }
            ]
        },
        footer: { // 页脚信息
            createYear: 2020, // 博客创建年份
            copyrightInfo: 'Liu Jiawei | MIT License', // 博客版权信息，支持a标签
        }
    },
    plugins: [ // 插件
